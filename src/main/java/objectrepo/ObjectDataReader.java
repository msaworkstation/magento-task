...
public class ObjectDataReader {
    ...
    public static Map<TestCaseID, Map<WebObjects, WebObjectValue>> getObjectData() {
        ...
        ts002.put(LOG_IN_LINK, new WebObjectValue(XPATH, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(EMAIL_INPUT, new WebObjectValue(ID, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(PASSWORD_INPUT, new WebObjectValue(ID, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(LOG_IN_BUTTON, new WebObjectValue(ID, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(MEN_LINK, new WebObjectValue(XPATH, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(SHIRTS_LINK, new WebObjectValue(XPATH, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(FIRST_ITEM, new WebObjectValue(XPATH, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(SELECT_COLOR, new WebObjectValue(ID, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(SELECT_SIZE, new WebObjectValue(ID, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(ADD_TO_CART_BUTTON, new WebObjectValue(XPATH, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
        ts002.put(GRAND_PRICE, new WebObjectValue(XPATH, "//a[@class='skip-link skip-account']/span[contains(text(),'Account')]"));
